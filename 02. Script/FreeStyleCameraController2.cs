...
public class FreeStyleCameraController2 : MonoBehaviour
{
    ...
    private void CameraOrbit()
    {
        ...
        if (Input.GetKey(KeyCode.LeftAlt) && Input.GetMouseButton(1))
        {
            ...
            transform.RotateAround(Target, Vector3.up, mouseX * OrbitSpeed * 100 * Time.deltaTime);
            transform.RotateAround(Target, Vector3.back, mouseY * OrbitSpeed * 100 * Time.deltaTime);
